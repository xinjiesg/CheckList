...
//        todos.insert(item, at: index)
    ...
    func remove(_ items: ChecklistItem, from priority: Priority, at index: Int){
        switch priority{
            case .high:
    ...
    private func randomTitle() -> String{
        ...
        let ramdomNumber = Int.random(in: 0 ... titles.count - 1 )
        return titles[ramdomNumber]
    }
}
